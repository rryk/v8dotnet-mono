...
namespace V8.Net
{
    ...
    public unsafe struct HandleProxy
    {
        ...
        public Int32 _ManagedObjectID; // If set (>=0), then a managed object is associated with this handle. The default is -1.
        // (Note: This is only valid after calling 'GetManagedObjectID()' at least once.)
        ...
        [FieldOffset(12), MarshalAs(UnmanagedType.I8)]
        ...
        [FieldOffset(28), MarshalAs(UnmanagedType.I8)]
        ...
        // --------------------------------------------------------------------------------------------------------------------
        // Properties for interpretation.

        public bool IsDisposeReady
        {
            get { return Disposed == 1; }
            set { if (Disposed < 2) Disposed = value ? 1 : 0; }
        }
        public bool IsDisposed { get { return Disposed == 2; } }
        ...
        public object Value
        {
            get
            {
                ...
                switch (_ValueType)
                {
                    ...
                    case JSValueType.Int32: return V8Integer;
